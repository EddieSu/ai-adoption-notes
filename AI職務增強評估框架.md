...
> (越靠「製作」端,放大越多)
>
> ⚠️ **前提:資料要先到位。** 這條公式只有在該職務的資料 ① AI 接得到、② 准上雲 時才算數——資料沒到位**不是紅利小一點,而是先做不了**(例:落在甜蜜點的職務,若資料還停在手寫紙本,得先數位化才放得出紅利)。見《[資料數位化程度與AI介入](資料數位化程度與AI介入.md)》。

**導入順序(由矩陣直接讀出)**

1. **先打 🔥 區**(文件 × 製作 / 使用、制度 × 製作):紅利大、易驗證、ROI 最明顯,拿來證明效益、說服老闆。(🔥 區裡,**資料已在高級〔ERP / API〕的先做**——資料還在紙本的得先數位化。)
2. **再推 ⚡ 區的人往右爬**:對「被服務」者做訓練,讓他們從「被服務」→「使用」,把看得到吃不到的紅利兌現。
3. **決策層(🌱/⚡)以輔助為主**:AI 當參謀、加速分析,**最終判斷仍由人保留**(AI 在此最不成熟、風險最高)。

---

> **資料要先過兩關**才回到這張矩陣:**准不准用**(敏感度,見《[資料防護](雲端AI資料防護構想.md)》)、**能不能用**(可用度,見《[資料數位化程度與AI介入](資料數位化程度與AI介入.md)》)。

---

> **系列**:[總覽](00-AI導入總覽.md)｜① [資料防護](雲端AI資料防護構想.md)｜**② 職務框架（本篇）**｜③ [價值飛輪](AI增效價值飛輪與分配.md)｜🔧 [Claude 落地](Claude落地實作示例.md)｜📊 [資料數位化](資料數位化程度與AI介入.md)
